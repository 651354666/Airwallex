 ...
 */
export declare class EmptyRuleSuggester implements ISuggester<void> {
    /**
     ...
     */
    suggestMutation(complaint: ILesshintComplaint, config: void, fileInfo: IFileInfo): ITextDeleteMutation;
}

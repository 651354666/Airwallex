 ...
 */
export declare class FinalNewlineSuggester implements ISuggester<void> {
    /**
     ...
     */
    suggestMutation(complaint: ILesshintComplaint, config: void, fileInfo: IFileInfo): ITextInsertMutation | undefined;
}

...
var mutatorSearcher_1 = require("../../lib/mutatorSearcher");
/**
...
var CaseRunner = /** @class */ (function () {
     ...
     */
    CaseRunner.prototype.runCase = function (testCase) {
        return __awaiter(this, void 0, void 0, function () {
            var mutatorSearcher, stubLogger, stubFileProvider, mutationsApplier, actual;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        stubLogger = new logger_1.Logger();
                        stubFileProvider = new stubFileProvider_1.StubFileProvider(testCase.before);
                        ...
                        return [4 /*yield*/, mutationsApplier.applyFileMutations([testCase.directoryPath.join("/"), testCase.name].join("/"), testCase.mutations)];
                    case 1:
                        actual = _a.sent();
                        // Assert
